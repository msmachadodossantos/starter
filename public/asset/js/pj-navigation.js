 ...
 * This prevents the script from running on elements that haven't been rendered yet.
 *
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const topNavigation = document.querySelector(".pj-navigation.fixed-top");
  const bottomNavigation = document.querySelector(
    ".pj-navigation.fixed-bottom",
  );
